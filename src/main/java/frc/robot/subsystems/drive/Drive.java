...
import frc.robot.subsystems.drive.QuestNav.QuestNavConstants;
...
public class Drive extends SubsystemBase {
  ...
  public void periodic() {
    ...
    Logger.recordOutput("Odometry/QuestinFieldCoordinates", getPose().transformBy(QuestNavConstants.robotToQuestTransform));
  }
